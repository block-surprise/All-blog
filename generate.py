...
- 内容は正確性を重視し、確認できない情報を事実として書かないこと
- 重要な事実や数値には、可能な限り参照元・出典を明記すること
- 参照元は本文中に「（出典：媒体名）」の形式で記載すること
- 最後の「まとめ」の前に、参照した主要な情報源を記載すること
- 情報源を記載する場合も、使用できるHTMLタグは<p>タグのみとすること
- URLを記載する場合は、可能な限り<a href="URL">媒体名</a>の形式にすること
- 存在しない情報源やURLを絶対に作らないこと
- 実際に参照できない情報について「報道によれば」など曖昧な表現でごまかさないこと
